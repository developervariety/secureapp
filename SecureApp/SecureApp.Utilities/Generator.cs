...
namespace SecureAppUtil
{
    public class Generator
    {
        ...
        public string Generate(LicenseKey data)
        {
            ...
            byte[] rndBytes = BitConverter.GetBytes(Extensions.Random.Int());
            ...
            return
                $"{text.Substring(0, 5)}-{text.Substring(5, 5)}-{text.Substring(10, 6)}-{text.Substring(16, 5)}-{text.Substring(21, 5)}".ToUpperInvariant();
        }
